...
export const SET_CART_ADDITIONAL_ITEMS = "setAdditionalItems";
export const SET_CART_RECEIVING_TYPE = "setReceivingType";
export const SET_CART_PHONE = "setPhone";
export const SET_CART_ADDRESS_STREET = "setAddressStreet";
export const SET_CART_ADDRESS_BUILDING = "setAddressBuilding";
export const SET_CART_ADDRESS_APARTMENT = "setAddressApartment";
